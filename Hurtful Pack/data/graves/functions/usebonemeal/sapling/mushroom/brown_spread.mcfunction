summon area_effect_cloud ~2 ~2 ~2 {Tags:["g.spreadshroom","g.brownshroom","g.SU.mushroom"],Duration:1}
summon area_effect_cloud ~-2 ~2 ~-2 {Tags:["g.spreadshroom","g.brownshroom","g.SU.mushroom"],Duration:1}
summon area_effect_cloud ~-2 ~2 ~2 {Tags:["g.spreadshroom","g.brownshroom","g.SU.mushroom"],Duration:1}
summon area_effect_cloud ~2 ~2 ~-2 {Tags:["g.spreadshroom","g.brownshroom","g.SU.mushroom"],Duration:1}
summon area_effect_cloud ~1 ~2 ~2 {Tags:["g.brownshroom","g.SU.mushroom"],Duration:1}
...
execute as @e[tag=g.SU.mushroom,tag=g.brownshroom,limit=4,sort=random,distance=..5] at @s[tag=!g.SU.T.mushroom] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["g.mushroom","g.brownshroom"],NoGravity:0b,NoBasePlate:1b,ShowArms:1b,DisabledSlots:2039327}
