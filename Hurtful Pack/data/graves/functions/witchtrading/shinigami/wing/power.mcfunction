...
#Righclick on block
execute if entity @s[scores={wt.shinigami=..5},tag=!wt.shinigami_rocket] run summon minecraft:area_effect_cloud ~ ~0.65 ~ {ReapplicationDelay:40,Effects:[{Id:9b,Amplifier:0b,Duration:100,ShowParticles:1b},{Id:2b,Amplifier:1b,Duration:75,ShowParticles:1b}],Radius:0.5f,Duration:300,RadiusPerTick:0.1f,Particle:"minecraft:large_smoke"}
