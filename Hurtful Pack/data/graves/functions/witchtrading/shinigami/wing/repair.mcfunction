...
replaceitem entity @s armor.chest minecraft:elytra{display:{Name:"{\"text\":\"Shinigami Wings\",\"color\":\"yellow\",\"italic\":false}",Lore:["{\"text\":\"...a contract until eternity\"}"]},Enchantments:[{id:projectile_protection,lvl:3},{id:thorns,lvl:2},{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}],HideFlags:1,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;0,81202,0,187255],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:1,Operation:0,UUID:[I;0,81202,0,187255],Slot:"chest"}],RepairCost:99999999} 1
