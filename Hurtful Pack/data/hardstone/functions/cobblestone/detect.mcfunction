...
#diamond poof effect
execute if entity @s[scores={hs.minedia=1..}] as @e[distance=..8,type=minecraft:item,limit=1,sort=nearest,nbt={Age:0s,Item:{id:"minecraft:cobblestone_slab",Count:1b}}] at @s run function hardstone:diamond/vanish
#reset score
