#tired mechanic
execute as @e[type=minecraft:end_crystal,distance=..1,limit=1,sort=nearest] run function limitedlife:curing/tired/start
#player effects
...
execute as @e[distance=..48,tag=ll.bat,limit=1,sort=nearest] if entity @s[type=minecraft:bat] at @e[type=minecraft:end_crystal,distance=..48,limit=1,sort=nearest] run summon minecraft:tnt ~ ~ ~
