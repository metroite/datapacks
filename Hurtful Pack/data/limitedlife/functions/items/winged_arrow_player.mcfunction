...
execute if entity @s[scores={ll.wa.shoot=1..}] run tag @e[type=minecraft:arrow,limit=1,sort=nearest,nbt={inGround:0b}] add ll.wa.arrow
...
execute if entity @s[scores={ll.wa.shootc=1..}] run tag @e[type=minecraft:arrow,limit=1,sort=nearest,nbt={inGround:0b}] add ll.wa.arrow
