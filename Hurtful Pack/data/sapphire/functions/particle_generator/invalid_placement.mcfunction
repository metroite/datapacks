...
summon minecraft:area_effect_cloud ~ ~ ~ {Particle:"dust",Radius:0.1f,RadiusPerTick:0f,RadiusOnUse:0.1f,Duration:100,Color:3349247,Effects:[{Id:13b,Amplifier:0b,Duration:30}]}
