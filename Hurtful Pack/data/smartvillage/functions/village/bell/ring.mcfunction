...
execute unless score @s sv.center_y matches -5..5 run function smartvillage:village/bell/centered_no
execute unless score @s sv.center_z matches -15..15 run function smartvillage:village/bell/centered_no
