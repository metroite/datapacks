...
execute as @e[type=minecraft:area_effect_cloud,tag=to.tag.torch,distance=..7] at @s if block ~ ~ ~ minecraft:torch run tag @s add to.tag.fail
execute as @e[type=minecraft:area_effect_cloud,tag=to.tag.torch,distance=..7] at @s if block ~ ~ ~ minecraft:wall_torch run tag @s add to.tag.fail
execute as @e[type=minecraft:area_effect_cloud,tag=to.tag.fail,distance=..12] at @s run function torchout:placement-api_torch/detection/out
...
execute as @e[type=minecraft:area_effect_cloud,tag=to.tag.fail,distance=..12] at @s run function torchout:placement-api_torch/detection/in
