execute if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow",tag:{CustomModelData:7186}}}] run tag @e[type=minecraft:arrow,distance=..5,limit=1,sort=nearest] add to.ta.arrow
