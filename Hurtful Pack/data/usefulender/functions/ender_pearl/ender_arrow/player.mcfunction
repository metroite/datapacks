...
advancement grant @s[scores={ue.ea.shoot=1..}] only usefulender:ender_arrow
...
execute if entity @s[scores={ue.ea.shoot=1..}] run clear @s minecraft:ender_pearl 1
execute if entity @s[scores={ue.ea.shoot=1..}] run give @s minecraft:arrow 1
...
execute if entity @s[scores={ue.ea.shootc=1..},nbt={SelectedItem:{id:"minecraft:crossbow",tag:{ChargedProjectiles:[]}}}] run data modify entity @s SelectedItem.tag.CustomModelData set value 0
