...
#gravity
execute if entity @s[nbt={NoAI:1b}] if block ~ ~-0.25 ~ #worseoldpvp:nocollision if block ~0.2 ~-0.25 ~0.2 #worseoldpvp:nocollision if block ~-0.2 ~-0.25 ~-0.2 #worseoldpvp:nocollision if block ~0.2 ~-0.25 ~-0.2 #worseoldpvp:nocollision if block ~-0.2 ~-0.25 ~0.2 #worseoldpvp:nocollision run tp @s ~ ~-0.24 ~
#if hit regain ai
