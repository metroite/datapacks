...
#summoning the bones
execute as @s unless block ~ ~-0.5 ~ #graves:generatable run summon armor_stand ~ ~-1.42 ~ {Invisible:1b,Invulnerable:1b,Tags:["g.bone"],NoGravity:1b,NoBasePlate:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:bone",Count:1b},{}],DisabledSlots:1,Rotation:[131f],Pose:{RightArm:[0f,0f,90f]}}
execute as @s unless block ~ ~-0.5 ~ #graves:generatable run summon armor_stand ~-1.2 ~-1.42 ~ {Invisible:1b,Invulnerable:1b,Tags:["g.bone"],NoGravity:1b,NoBasePlate:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:bone",Count:1b},{}],DisabledSlots:1,Rotation:[250f],Pose:{RightArm:[0f,0f,90f]}}
execute as @s unless block ~ ~-0.5 ~ #graves:generatable run summon armor_stand ~1 ~-1.42 ~ {Invisible:1b,Invulnerable:1b,Tags:["g.bone","g.bone+"],NoGravity:1b,NoBasePlate:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:bone",Count:1b},{}],DisabledSlots:1,Rotation:[343f],Pose:{RightArm:[0f,0f,90f]}}
