...
#summoning the bones
execute as @s unless block ~ ~-0.5 ~ #graves:generatable run summon armor_stand ~-0.2 ~2 ~0.8 {Invisible:1b,Invulnerable:1b,Tags:["g.bone","g.nogravity"],HurtTime:18000s,NoGravity:0b,NoBasePlate:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:bone",Count:1b},{}],DisabledSlots:2039326,Rotation:[131f],Pose:{RightArm:[230f,0f,90f]}}
execute as @s unless block ~ ~-0.5 ~ #graves:generatable run summon armor_stand ~-1 ~2 ~-1 {Invisible:1b,Invulnerable:1b,Tags:["g.bone","g.nogravity"],HurtTime:18000s,NoGravity:0b,NoBasePlate:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:bone",Count:1b},{}],DisabledSlots:2039326,Rotation:[250f],Pose:{RightArm:[230f,0f,90f]}}
execute as @s unless block ~ ~-0.5 ~ #graves:generatable run summon armor_stand ~1.2 ~2 ~0.4 {Invisible:1b,Invulnerable:1b,Tags:["g.bone","g.bone+","g.nogravity"],HurtTime:18000s,NoGravity:0b,NoBasePlate:1b,ShowArms:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:bone",Count:1b},{}],DisabledSlots:2039326,Rotation:[343f],Pose:{RightArm:[230f,0f,90f]}}
