#placing the skull
execute as @s[tag=g.north] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=0] destroy
execute as @s[tag=g.east] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=4] destroy
execute as @s[tag=g.south] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=8] destroy
execute as @s[tag=g.west] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=12] destroy
execute as @s[tag=g.south-west] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=10] destroy
execute as @s[tag=g.north-west] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=14] destroy
execute as @s[tag=g.north-east] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=2] destroy
execute as @s[tag=g.south-east] run setblock ~ ~ ~ minecraft:skeleton_skull[rotation=6] destroy
