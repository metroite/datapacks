fill ~ ~ ~ ~ ~ ~ minecraft:stripped_jungle_log[axis=y] replace
...
execute at @s[tag=g.jungle] run fill ^ ^-1 ^-1 ^ ^-1 ^-1 minecraft:stripped_jungle_log[axis=y] replace minecraft:air
...
execute at @s[scores={g.sapling_height=290..305}] run fill ~5 ~ ~5 ~-5 ~-1 ~-5 minecraft:jungle_leaves[persistent=false] replace minecraft:air
execute at @s[scores={g.sapling_height=305..317}] run fill ~4 ~ ~4 ~-4 ~ ~-4 minecraft:jungle_leaves[persistent=false] replace minecraft:air
execute at @s[scores={g.sapling_height=317..}] run fill ~2 ~ ~2 ~-2 ~1 ~-2 minecraft:jungle_leaves[persistent=false] replace minecraft:air
