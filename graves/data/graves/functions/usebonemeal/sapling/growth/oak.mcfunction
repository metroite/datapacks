...
execute at @s[scores={g.sapling_height=215..225}] run fill ~2 ~ ~2 ~-2 ~ ~-2 minecraft:oak_leaves[persistent=false] replace minecraft:air
execute at @s[scores={g.sapling_height=226..}] run fill ~1 ~ ~1 ~-1 ~1 ~-1 minecraft:oak_leaves[persistent=false] replace minecraft:air
