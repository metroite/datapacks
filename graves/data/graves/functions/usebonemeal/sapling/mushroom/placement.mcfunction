...
execute at @s[nbt={OnGround:1b},tag=g.redshroom] if block ~ ~-1 ~ #graves:shroomable if block ~ ~ ~ #graves:space unless block ~ ~ ~1 #graves:mushroom unless block ~ ~ ~-1 #graves:mushroom unless block ~1 ~ ~ #graves:mushroom unless block ~-1 ~ ~ #graves:mushroom run particle minecraft:angry_villager ~ ~0.1 ~ 0.1 0.1 0.1 1 1 normal
execute at @s[nbt={OnGround:1b},tag=g.brownshroom] if block ~ ~-1 ~ #graves:shroomable if block ~ ~ ~ #graves:space unless block ~ ~ ~1 #graves:mushroom unless block ~ ~ ~-1 #graves:mushroom unless block ~1 ~ ~ #graves:mushroom unless block ~-1 ~ ~ #graves:mushroom run particle minecraft:angry_villager ~ ~0.1 ~ 0.1 0.1 0.1 1 1 normal
