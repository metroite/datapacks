...
execute at @s[nbt={FallFlying:1b}] anchored eyes run particle minecraft:dust 0.2314 0.2314 0.25098 3 ^-1.5 ^ ^0.5 0 0 0 0.5 1 force
execute at @s[nbt={FallFlying:0b}] if entity @p[scores={wt.rng=6..11}] positioned ^ ^ ^-0.7 run particle minecraft:dust 0.2314 0.2314 0.25098 3 ~ ~0.7 ~ 0.2 0.4 0.05 0.5 1 force

#calling shinigami_wing_kill: kill if elytra is removed
execute as @s[type=minecraft:player,nbt={Inventory:[{Slot:102b,id:"minecraft:elytra",tag:{Damage:431,display:{Name:"{\"text\":\"Shinigami Wings\",\"color\":\"yellow\",\"italic\":false}",Lore:["{\"text\":\"...a contract until eternity\"}"]}}}]}] at @s run function graves:witchtrading/shinigami/wing/kill
execute as @s[type=!minecraft:player,nbt=!{ArmorItems:[{},{},{id:"minecraft:elytra",tag:{display:{Name:"{\"text\":\"Shinigami Wings\",\"color\":\"yellow\",\"italic\":false}",Lore:["{\"text\":\"...a contract until eternity\"}"]}}},{}]}] at @s run function graves:witchtrading/shinigami/wing/kill
