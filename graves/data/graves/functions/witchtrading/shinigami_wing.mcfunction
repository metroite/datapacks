...
execute at @s[tag=!wt.P.shinigami_wing.SU] run playsound minecraft:entity.bat.loop voice @a ~ ~ ~ 0.5 0.5
execute at @s[tag=!wt.P.shinigami_wing.SU] run playsound minecraft:entity.vex.charge voice @a ~ ~ ~ 2 1.2
execute at @s[tag=!wt.P.shinigami_wing.SU] run playsound minecraft:entity.vex.charge voice @a ~ ~ ~ 2 1.2
execute at @s[tag=!wt.P.shinigami_wing.SU] run playsound minecraft:entity.vex.charge voice @a ~ ~ ~ 2 1.2
