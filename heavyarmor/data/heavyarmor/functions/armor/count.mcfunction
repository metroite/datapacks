...
scoreboard players add @s[nbt={Inventory:[{Slot:103b,id:"minecraft:chainmail_helmet"}]}] ha.armorcount 5
...
scoreboard players add @s[nbt={Inventory:[{Slot:103b,id:"minecraft:iron_helmet"}]}] ha.armorcount 10
...
scoreboard players add @s[nbt={Inventory:[{Slot:103b,id:"minecraft:diamond_helmet"}]}] ha.armorcount 8
