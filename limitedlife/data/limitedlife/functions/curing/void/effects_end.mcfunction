...
execute positioned ~ 150 ~ as @e[distance=..150,sort=random,limit=10] if entity @s[type=minecraft:bat,tag=ll.curedvoid] as @a[limit=1,sort=random,scores={ll.deaths=10}] at @s run function limitedlife:curing/void/revive
