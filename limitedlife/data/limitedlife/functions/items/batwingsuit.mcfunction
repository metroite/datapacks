...
execute at @s[tag=ll.batwingflap,nbt={FallFlying:0b}] run effect give @s levitation 10 65 true
effect clear @s[nbt={FallFlying:0b,OnGround:0b}] minecraft:levitation
