...
execute unless entity @p[distance=..8,nbt={SelectedItem:{id:"minecraft:diamond_pickaxe"}}] positioned ~ ~0.5 ~ run kill @e[type=minecraft:item,tag=!pa.dropped,limit=1,sort=nearest,distance=..0.5,nbt={Item:{id:"minecraft:light_blue_stained_glass"}}]
