...
execute as @s[tag=sp.valid] positioned ~ ~-1 ~ unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:glass run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:216374,Tags:["sp.sapphire_glass","sp.sapphire_glasssetup","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~ ~1 ~ unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:glass run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:216374,Tags:["sp.sapphire_glass","sp.sapphire_glasssetup","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~ ~ ~1 unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:glass run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:216374,Tags:["sp.sapphire_glass","sp.sapphire_glasssetup","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~ ~ ~-1 unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:glass run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:216374,Tags:["sp.sapphire_glass","sp.sapphire_glasssetup","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~1 ~ ~ unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:glass run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:216374,Tags:["sp.sapphire_glass","sp.sapphire_glasssetup","metroite.placement","metroite.place"]}
