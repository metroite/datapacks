...
execute if score x_random sp.sapphire > 65 sp.sapphire run fill ~ ~ ~ ~ ~ ~ minecraft:light_blue_stained_glass replace minecraft:glass

##placement effects
particle minecraft:dust 0.25 0.1 1 1.25 ~ ~0.5 ~ 0.4 0.4 0.4 1 24
#success
execute if score x_random sp.sapphire > 65 sp.sapphire run playsound minecraft:ui.toast.in block @a[distance=..16] ~ ~ ~ 2 2
#fail
