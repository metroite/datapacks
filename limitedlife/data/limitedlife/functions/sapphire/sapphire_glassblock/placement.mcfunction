...
execute positioned ^ ^1 ^ align xyz run summon area_effect_cloud ~0.5 ~ ~0.5 {Tags:["sp.C.glass"],Duration:1}
execute positioned ^ ^-1 ^ align xyz run summon area_effect_cloud ~0.5 ~ ~0.5 {Tags:["sp.C.glass"],Duration:1}
execute positioned ^1 ^ ^ align xyz run summon area_effect_cloud ~0.5 ~ ~0.5 {Tags:["sp.C.glass"],Duration:1}
execute positioned ^-1 ^ ^ align xyz run summon area_effect_cloud ~0.5 ~ ~0.5 {Tags:["sp.C.glass"],Duration:1}
...
execute as @s[scores={sp.glass_placed=..7}] at @s run function limitedlife:sapphire/sapphire_glassblock/placement
