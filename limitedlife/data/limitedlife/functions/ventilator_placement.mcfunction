...
execute as @s[tag=ll.valid] positioned ~ ~-1 ~ unless entity @e[type=armor_stand,tag=ll.fan,distance=..0.5] if block ~ ~ ~ minecraft:observer run summon armor_stand ~ ~ ~ {NoGravity:1b,Tags:["ll.fan","ll.fansetup"],Small:0b,Invisible:0b,Marker:1b}
execute as @s[tag=ll.valid] positioned ~ ~1 ~ unless entity @e[type=armor_stand,tag=ll.fan,distance=..0.5] if block ~ ~ ~ minecraft:observer run summon armor_stand ~ ~ ~ {NoGravity:1b,Tags:["ll.fan","ll.fansetup"],Small:0b,Invisible:0b,Marker:1b}
execute as @s[tag=ll.valid] positioned ~ ~ ~1 unless entity @e[type=armor_stand,tag=ll.fan,distance=..0.5] if block ~ ~ ~ minecraft:observer run summon armor_stand ~ ~ ~ {NoGravity:1b,Tags:["ll.fan","ll.fansetup"],Small:0b,Invisible:0b,Marker:1b}
execute as @s[tag=ll.valid] positioned ~ ~ ~-1 unless entity @e[type=armor_stand,tag=ll.fan,distance=..0.5] if block ~ ~ ~ minecraft:observer run summon armor_stand ~ ~ ~ {NoGravity:1b,Tags:["ll.fan","ll.fansetup"],Small:0b,Invisible:0b,Marker:1b}
execute as @s[tag=ll.valid] positioned ~1 ~ ~ unless entity @e[type=armor_stand,tag=ll.fan,distance=..0.5] if block ~ ~ ~ minecraft:observer run summon armor_stand ~ ~ ~ {NoGravity:1b,Tags:["ll.fan","ll.fansetup"],Small:0b,Invisible:0b,Marker:1b}
