...
summon armor_stand ~ ~ ~ {NoGravity:1b,Tags:["sp.sapphire_ore","sp.sapphire_main"],Pose:{Head:[45f,0f,0f]},ArmorItems:[{},{},{},{id:"lapis_block",Count:1b}],HandItems:[{},{}],DisabledSlots:2039583,Small:1b,Invisible:1b,Marker:1b}
