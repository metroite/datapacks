...
#remove tag (decolor)
execute if entity @s[tag=!sp.particle_white] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:bone_meal"}}] run function sapphire:particle_generator/decolor
...
execute if entity @s[tag=!sp.particle_yellow] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:dandelion_yellow"}}] run function sapphire:particle_generator/decolor
...
execute if entity @s[tag=!sp.particle_blue] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:lapis_lazuli"}}] run function sapphire:particle_generator/decolor
...
execute if entity @s[tag=!sp.particle_brown] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:cocoa_beans"}}] run function sapphire:particle_generator/decolor
...
execute if entity @s[tag=!sp.particle_green] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:cactus_green"}}] run function sapphire:particle_generator/decolor
execute if entity @s[tag=!sp.particle_red] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:rose_red"}}] run function sapphire:particle_generator/decolor
execute if entity @s[tag=!sp.particle_black] align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:item,distance=..0.9,nbt={Item:{Count:1b,id:"minecraft:ink_sac"}}] run function sapphire:particle_generator/decolor
