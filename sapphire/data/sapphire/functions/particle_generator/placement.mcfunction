...
execute as @s[tag=sp.valid] positioned ~ ~-1 ~ unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:observer run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483637,Tags:["sp.particle","sp.particle_blue","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~ ~1 ~ unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:observer run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483637,Tags:["sp.particle","sp.particle_blue","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~ ~ ~1 unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:observer run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483637,Tags:["sp.particle","sp.particle_blue","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~ ~ ~-1 unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:observer run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483637,Tags:["sp.particle","sp.particle_blue","metroite.placement","metroite.place"]}
execute as @s[tag=sp.valid] positioned ~1 ~ ~ unless entity @e[tag=metroite.place,distance=..0.5] unless entity @e[tag=metroite.placement,distance=..3] if block ~ ~ ~ minecraft:observer run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483637,Tags:["sp.particle","sp.particle_blue","metroite.placement","metroite.place"]}
...
#setup sp.particle
execute as @s[tag=sp.valid] as @e[tag=sp.particle,tag=metroite.placement,limit=1,sort=nearest] at @s run function sapphire:particle_generator/facing
