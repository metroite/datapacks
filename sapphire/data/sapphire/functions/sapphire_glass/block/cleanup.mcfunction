...
execute if entity @p[distance=..8,nbt={SelectedItem:{id:"minecraft:diamond_pickaxe"}},scores={sp.glass_broken=1..}] run data merge entity @e[type=minecraft:item,limit=1,sort=nearest,distance=..2,nbt=!{Item:{id:"minecraft:light_blue_stained_glass",Count:1b,tag:{}}},nbt={Age:0s,Item:{id:"minecraft:light_blue_stained_glass",Count:1b}}] {Item:{id:"minecraft:light_blue_stained_glass",Count:1b,tag:{CustomModelData:8771,display:{Name:"{\"text\":\"Sapphire Glass\",\"color\":\"aqua\",\"italic\":false}"},Enchantments:[{lvl:1s,id:"minecraft:binding_curse"},{lvl:1s,id:"minecraft:vanishing_curse",AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,Operation:0,UUIDLeast:897636,UUIDMost:510691,Slot:"head"},{AttributeName:"generic.armorToughness",Name:"generic.armorToughness",Amount:2,Operation:0,UUIDLeast:584132,UUIDMost:458804,Slot:"head"},{AttributeName:"generic.maxHealth",Name:"generic.maxHealth",Slot:"head",Amount:-0.9,Operation:1,UUIDMost:91333,UUIDLeast:112233}]}]}}}
...
execute unless entity @a[distance=..8,nbt={SelectedItem:{id:"minecraft:diamond_pickaxe"}},scores={sp.glass_broken=1..}] at @p[distance=..8] unless entity @p[distance=..1,gamemode=creative] at @s positioned ~ ~0.5 ~ run kill @e[type=minecraft:item,limit=1,sort=nearest,nbt=!{Item:{id:"minecraft:light_blue_stained_glass",tag:{}}},nbt={Age:0s,Item:{id:"minecraft:light_blue_stained_glass",Count:1b}},distance=..2]
