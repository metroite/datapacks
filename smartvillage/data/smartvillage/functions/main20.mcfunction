...
execute as @e[type=minecraft:villager,limit=1,sort=random,tag=!sv.marked,tag=!sv.summoned,tag=!wt.villager] at @s run function smartvillage:village/common/scores
execute as @e[type=minecraft:villager,limit=1,sort=random,tag=sv.marked,tag=!sv.summoned,tag=!wt.villager,scores={sv.center_x=0,sv.center_y=0,sv.center_z=0}] at @s run function smartvillage:village/common/scores
