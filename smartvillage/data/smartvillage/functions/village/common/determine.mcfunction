...
execute unless score @s sv.center_y matches -50..50 run function smartvillage:village/outside
execute unless score @s sv.center_z matches -90..90 run function smartvillage:village/outside
