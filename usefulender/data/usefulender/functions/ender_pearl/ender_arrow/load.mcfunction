...
#mainhand
data modify entity @s[nbt={SelectedItem:{tag:{Charged:1b,ChargedProjectiles:[{id:"minecraft:arrow"}]}}}] SelectedItem.tag.CustomModelData set value 7131
...
#offhand
data modify entity @s[nbt={Inventory:[{Slot:-106b,tag:{Charged:1b,ChargedProjectiles:[{id:"minecraft:arrow"}]}}]}] Inventory[-1].tag.CustomModelData set value 7131
