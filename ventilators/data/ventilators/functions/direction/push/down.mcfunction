execute positioned ~-0.5 ~ ~-0.5 as @e[dy=1,type=!minecraft:area_effect_cloud,limit=1,sort=nearest,tag=!no] at @s run function ventilators:direction/push/motion/down
