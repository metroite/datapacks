...
execute positioned ~-0.5 ~ ~-0.5 as @a[gamemode=!spectator,dy=1,limit=1,sort=nearest,nbt=!{ActiveEffects:[{Id:25b}]}] run effect give @s[nbt={FallFlying:0b}] minecraft:levitation 1 15 true
