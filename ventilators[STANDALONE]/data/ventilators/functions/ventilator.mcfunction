...
execute as @s[tag=ll.fansouth] if block ~ ~ ~ minecraft:observer[powered=true] positioned ~-0.5 ~ ~-0.5 as @a[dz=-5,limit=1,sort=nearest] at @s run function ventilators:collision/collision_south
execute as @s[tag=ll.fanwest] if block ~ ~ ~ minecraft:observer[powered=true] positioned ~-0.5 ~ ~-0.5 as @a[dx=5,limit=1,sort=nearest] at @s run function ventilators:collision/collision_west
execute as @s[tag=ll.fannorth] if block ~ ~ ~ minecraft:observer[powered=true] positioned ~-0.5 ~ ~-0.5 as @a[dz=5,limit=1,sort=nearest] at @s run function ventilators:collision/collision_north
execute as @s[tag=ll.faneast] if block ~ ~ ~ minecraft:observer[powered=true] positioned ~-0.5 ~ ~-0.5 as @a[dx=-5,limit=1,sort=nearest] at @s run function ventilators:collision/collision_east
