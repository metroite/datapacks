...
execute as @s[tag=ll.fanup] if block ~ ~ ~ minecraft:observer[powered=true] positioned ~-0.5 ~-4 ~-0.5 run effect give @a[dy=4,limit=1,sort=nearest,nbt={OnGround:0b}] minecraft:levitation 1 220 true
