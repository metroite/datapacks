#effects and motion
execute as @s[tag=ll.fansouth] at @s if block ~ ~ ~ minecraft:observer[powered=true] run particle minecraft:poof ~ ~ ~-2 0.05 0.05 1 0.001 1 normal
execute as @s[tag=ll.fanwest] at @s if block ~ ~ ~ minecraft:observer[powered=true] run particle minecraft:poof ~2 ~ ~ 1 0.05 0.05 0.001 1 normal
execute as @s[tag=ll.fannorth] at @s if block ~ ~ ~ minecraft:observer[powered=true] run particle minecraft:poof ~ ~ ~2 0.05 0.05 1 0.001 1 normal
execute as @s[tag=ll.faneast] at @s if block ~ ~ ~ minecraft:observer[powered=true] run particle minecraft:poof ~-2 ~ ~ 1 0.05 0.05 0.001 1 normal
execute as @s[tag=ll.fanup] at @s if block ~ ~ ~ minecraft:observer[powered=true] run particle minecraft:poof ~ ~-2 ~ 0.05 1 0.05 0.001 1 normal
execute as @s[tag=ll.fandown] at @s if block ~ ~ ~ minecraft:observer[powered=true] run particle minecraft:poof ~ ~2 ~ 0.05 1 0.05 0.001 1 normal
