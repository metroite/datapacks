...
execute if entity @p[nbt={SelectedItem:{id:"minecraft:poisonous_potato"}},team=wt.friendly,distance=..6] run playsound minecraft:entity.villager.trade neutral @a[distance=..12] ~ ~ ~ 2 1.5
