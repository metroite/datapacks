...
execute as @e[type=minecraft:witch,team=!wt.friendly,tag=!wt.traded,tag=!wt.blocked] at @s unless entity @a[team=!wt.friendly,distance=..12] run function witchtrading:witch/befriend

#Determines what friendly witches do
execute as @e[team=wt.friendly,type=minecraft:witch] at @s run function witchtrading:witch/friendly
...
#Invisible Villager:
execute as @e[type=minecraft:villager,team=wt.friendly,nbt={Silent:1b}] at @s run function witchtrading:witch/invisible_villager

#Effects and Potion
execute as @a[team=wt.friendly,scores={wt.twv=1..}] at @s as @e[team=wt.friendly,distance=..6,tag=wt.traded,limit=1,sort=nearest] at @s run function witchtrading:witch/traded
...
execute as @a[scores={wt.ttv=1..}] at @s run function witchtrading:witch/trading
