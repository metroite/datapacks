...
#gravity
execute if entity @s[nbt={NoAI:1b}] if block ~ ~-0.5 ~ #worseoldpvp:nocollision if block ~0.2 ~-0.5 ~0.2 #worseoldpvp:nocollision if block ~-0.2 ~-0.5 ~-0.2 #worseoldpvp:nocollision if block ~0.2 ~-0.5 ~-0.2 #worseoldpvp:nocollision if block ~-0.2 ~-0.5 ~0.2 #worseoldpvp:nocollision run tp @s ~ ~-0.25 ~
#if hit regain ai
