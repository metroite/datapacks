...
#regain ai
execute unless entity @p[distance=..11,nbt={SelectedItem:{tag:{wopsword:1}}}] run data merge entity @s {NoAI:0b}
execute unless entity @p[distance=..11,nbt={SelectedItem:{tag:{wopsword:1}}}] run tag @s remove wop.noai
#gravity
...
execute unless entity @p[distance=..11,nbt={SelectedItem:{tag:{wopsword:1}}}] run scoreboard players reset @s wop.damage
