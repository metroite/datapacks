...
execute unless score $extend$ wop.extend matches 0.. wop.extend run scoreboard players set $extend$ wop.extend 6
execute unless score $mode$ wop.extend matches 0.. wop.extend run scoreboard players set $mode$ wop.extend 0
