effect clear @s[nbt={ActiveEffects:[{Id:2b,Amplifier:3b}]}] minecraft:slowness
effect clear @s[nbt={ActiveEffects:[{Id:11b,Amplifier:0b}]}] minecraft:resistance
