...
replaceitem entity @s[scores={wop.extend=0},nbt=!{Inventory:[{Slot:-106b}]}] weapon.offhand minecraft:carrot_on_a_stick{wopcarrot:1b,wopunblock:1b,Unbreakable:1b,Damage:13}
